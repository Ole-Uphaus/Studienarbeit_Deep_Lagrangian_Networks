...
if just_plot == False:
    ...
    mae_tau_percent_ELU= results['mae_tau_percent']
    ...
    results = {
        ...
        'mae_tau_percent_ELU': mae_tau_percent_ELU,
    }
    ...
    mae_tau_percent_ELU = results['mae_tau_percent_ELU']
    ...
    print(f"Prozentualer MAE Test ELU: {mae_tau_percent_ELU:4f}")
