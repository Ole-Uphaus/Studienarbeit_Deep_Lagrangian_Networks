...
if just_plot == False:
    ...
    save_path = os.path.join(script_path, 'Ergebnisse_Opt_Hyper_Allg_Training.npy')

    np.save(save_path, results)

else:

    data_path = os.path.join(script_path, 'Ergebnisse_Opt_Hyper_Allg_Training.npy')
    ...
    print(f"Prozentualer MAE Test: {results['mae_tau_percent']:4f}")
    ...
    plot_1_name_anh = os.path.join(plot_path_anh, 'Opt_Hyper_Massenmatrix.pdf')
