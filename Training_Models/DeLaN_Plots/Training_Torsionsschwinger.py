...
features_training, labels_training, _, _, _ = extract_training_data('Datensatz_Torsionsschwinger_Nruns_37.mat', target_folder)  # Mein Modell Trainingsdaten
_, _, features_test, labels_test, Mass_Cor_test = extract_training_data('Datensatz_Torsionsschwinger_Nruns_37.mat', target_folder)  # Mein Modell Testdaten (Immer dieselben Testdaten nutzen)
...
if just_plot == False:
    ...
    plot_1_name = os.path.join(plot_path, 'Training_Torsionsschwinger_inv_dyn.pdf')
    plot_3_name = os.path.join(plot_path, 'Training_Torsionsschwinger_coriolis_konservativ.pdf')
    plot_4_name = os.path.join(plot_path, 'Training_Torsionsschwinger_Massenmatrix.pdf')
    ...
    double_subplot(
        ...
        r'Samples',
        [r'$\tau_{T, 1} \, / \, \mathrm{Nm}$', r'$\tau_{T, 2} \, / \, \mathrm{Nm}$'],
        ['', ''],
        [['DeLaN', 'GT'], ['DeLaN', 'GT']],
        plot_1_name,
        save_plots,
    ...
    quad_subplot(
        ...
        r'Samples',
        [r'$M_{T,11} \, / \, \mathrm{kg} \, \mathrm{m}^2$',r'$M_{T,12} \, / \, \mathrm{kg} \, \mathrm{m}^2$',r'$M_{T,21} \, / \, \mathrm{kg} \, \mathrm{m}^2$',r'$M_{T,22} \, / \, \mathrm{kg} \, \mathrm{m}^2$'],
        ['', '', '', ''],
        [['DeLaN', 'GT'], ['DeLaN', 'GT'], ['DeLaN', 'GT'], ['DeLaN', 'GT']],
        plot_4_name,
        save_plots,
    ...
    save_path = os.path.join(script_path, 'Ergebnisse_Training_Torsionsschwinger.npy')

    np.save(save_path, results)

else:

    data_path = os.path.join(script_path, 'Ergebnisse_Training_Torsionsschwinger.npy')
    ...
    plot_path = r'D:\Programmierung_Ole\Latex\Studienarbeit_Repo_Overleaf\Bilder\06_Ergebnisse'
    plot_1_name = os.path.join(plot_path, 'Training_Torsionsschwinger_inv_dyn_beschl.pdf')
    plot_3_name = os.path.join(plot_path, 'Training_Torsionsschwinger_coriolis_konservativ.pdf')
