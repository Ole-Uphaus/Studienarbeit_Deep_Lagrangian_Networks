...
Datum:     29.07.2025
Beschreibung:
In diesem Skript wird das DeLaN modell auf dem standard Datensatz Trainiert. Dabei werden die Aktivierungsfunktionen der Diagonalelemente variiert, um deren Einfluss zu zeigen.
'''
...
if just_plot == False:
    ...
    data_path = os.path.join(script_path, 'Ergebnisse_Aktivierungsfunktion_diag.npy')
