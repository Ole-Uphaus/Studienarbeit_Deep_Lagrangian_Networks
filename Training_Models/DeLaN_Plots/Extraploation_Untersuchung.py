...
plot_2_name = os.path.join(plot_path, 'Extrapolation_loss.pdf')
plot_3_name = os.path.join(plot_path, 'Extrapolation_coriolis_konservativ.pdf')
plot_4_name = os.path.join(plot_path, 'Extrapolation_Massenmatrix.pdf')
