...
if just_plot == False:
    ...
    plot_path = r'D:\Programmierung_Ole\Latex\Studienarbeit_Repo_Overleaf\Bilder\06_Ergebnisse'
    plot_1_name = os.path.join(plot_path, 'Training_Doppelpendel_inv_dyn_beschl.pdf')
    plot_3_name = os.path.join(plot_path, 'Training_Doppelpendel_coriolis_konservativ.pdf')
    ...
    quad_subplot(
        ...
        r'Datenpunktindex',
        [r'$\tau_{RR, 1} \, / \, \mathrm{Nm}$',r'$\tau_{RR, 1}^{(tr)} \, / \, \mathrm{Nm}$',r'$\tau_{RR, 2} \, / \, \mathrm{Nm}$',r'$\tau_{RR, 1}^{(tr)} \, / \, \mathrm{Nm}$'],
        ['', '', '', ''],
        [[], [], [], ['GT', 'DeLaN']],
        plot_1_name,
        True,
    ...
    quad_subplot(
        ...
        r'Datenpunktindex',
        [r'$c_{RR,1} \, / \, \mathrm{Nm}$',r'$k^{(c)}_{RR,1} \, / \, \mathrm{Nm}$',r'$c_{RR,2} \, / \, \mathrm{Nm}$',r'$k^{(c)}_{RR,2} \, / \, \mathrm{Nm}$'],
        ['', '', '', ''],
        [[], [], ['GT', 'DeLaN'], []],
        plot_3_name,
        save_plots,
