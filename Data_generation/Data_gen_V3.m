...
Quad_Subplot(t_vec_ges, {Mass_Cor_training(:, 1), Mass_Cor_training(:, 2), Mass_Cor_training(:, 2), Mass_Cor_training(:, 3)}, ...
    '$\mathrm{Zeit} \,[\mathrm{s}]$', ...
    {'$M_{RS,11} \,[\mathrm{kg}]$','$M_{RS,12} \,[\mathrm{kg}\cdot m]$','$M_{RS,21} \,[\mathrm{kg}\cdot m]$','$M_{RS,22} \,[\mathrm{kg}\cdot m^2]$'}, ...
...
Quad_Subplot(t_vec_ges, {features_training(:, 3), labels_training(:, 1), features_training(:, 4), labels_training(:, 2)}, ...
    '$\mathrm{Zeit} \,[\mathrm{s}]$', ...
    {'$\dot{r}_{RS} \,[\mathrm{m/s}]$', '$\ddot{r}_{RS} \,[\mathrm{m/s^2}]$', '$\dot{\varphi}_{RS} \,[\mathrm{rad/s}]$', '$\ddot{\varphi}_{RS} \,[\mathrm{rad/s^2}]$'}, ...
    {'$\dot{r}_{RS}(t)$', '$\ddot{r}_{RS}(t)$', '$\dot{\varphi}_{RS}(t)$', '$\ddot{\varphi}_{RS}(t)$'}, ...
    {{'Trajektorie1'}, {'Trajektorie2'}}, ...
