...
plot_7_name = fullfile(plot_path, 'Abbildung_rt_phit_Rob_1.pdf');
...
samples_vec = 0:(size(features_training, 1) - 1);

% Plot 1 erstellen
Double_Subplot(samples_vec, {features_training(:, 1), features_training(:, 2)}, ...
    '$\mathrm{Datenpunktindex}$', ...
    {'$r_{RS} \, / \, \mathrm{m}$', '$\varphi_{RS} \, / \, \mathrm{rad}$'}, ...
    {'', ''}, ...
    {{'Trajektorie1'}, {'Trajektorie2'}}, ...
    plot_1_name, save_plots, false)

% Plot 2 Drehmoment
Double_Subplot(samples_vec, {features_training(:, 5), features_training(:, 6)}, ...
    '$\mathrm{Datenpunktindex}$', ...
    {'$F_{RS} \, / \, \mathrm{N}$', '$\tau_{RS} \, / \, \mathrm{Nm}$'}, ...
    {'', ''}, ...
    {{'Trajektorie1'}, {'Trajektorie2'}}, ...
    plot_2_name, save_plots, false)

% Plot 3 Massenmatrix
Quad_Subplot(samples_vec, {Mass_Cor_training(:, 1), Mass_Cor_training(:, 2), Mass_Cor_training(:, 2), Mass_Cor_training(:, 3)}, ...
    '$\mathrm{Datenpunktindex}$', ...
    {'$M_{RS,11} \, / \, \mathrm{kg}$','$M_{RS,12} \, / \, \mathrm{kg} \, \mathrm{m}$','$M_{RS,21} \, / \, \mathrm{kg} \, \mathrm{m}$','$M_{RS,22} \, / \, \mathrm{kg} \, \mathrm{m}^2$'}, ...
    {'', '', '', ''}, ...
    {{'Trajektorie1'}, {'Trajektorie2'}}, ...
    plot_3_name, save_plots, false)

% Plot 5
Quad_Subplot(samples_vec, {features_training(:, 3), labels_training(:, 1), features_training(:, 4), labels_training(:, 2)}, ...
    '$\mathrm{Datenpunktindex}$', ...
    {'$\dot{r}_{RS} \, / \, \mathrm{m} \, \mathrm{s}^{-1}$', '$\ddot{r}_{RS} \, / \, \mathrm{m} \, \mathrm{s}^{-2}$', '$\dot{\varphi}_{RS} \, / \, \mathrm{rad} \, \mathrm{s}^{-1}$', '$\ddot{\varphi}_{RS} \, / \, \mathrm{rad} \, \mathrm{s}^{-2}$'}, ...
    {'', '', '', ''}, ...
    {{'Trajektorie1'}, {'Trajektorie2'}}, ...
    plot_5_name, save_plots, false)

% Plot 6
Quad_Subplot(samples_vec, {Mass_Cor_training(:, 4), Mass_Cor_training(:, 6), Mass_Cor_training(:, 5), Mass_Cor_training(:, 7)}, ...
    '$\mathrm{Datenpunktindex}$', ...
    {'$c_{RS,1} \, / \, \mathrm{N}$','$k^{(c)}_{RS,1} \, / \, \mathrm{N}$','$c_{RS,2} \, / \, \mathrm{Nm}$','$k^{(c)}_{RS,2} \, / \, \mathrm{Nm}$'}, ...
    {'', '', '', ''}, ...
    {{'Trajektorie1'}, {'Trajektorie2'}}, ...
    plot_6_name, save_plots, false)

% Plot 7 erstellen
Double_Subplot(t_vec, {traj_data(training_idx(1)).q1, traj_data(training_idx(1)).q2}, ...
    '$\mathrm{Zeit} \, / \, \mathrm{s}$', ...
    {'$r_{RS} \, / \, \mathrm{m}$', '$\varphi_{RS} \, / \, \mathrm{rad}$'}, ...
    {'', ''}, ...
    {{'Trajektorie1'}, {'Trajektorie2'}}, ...
    plot_7_name, save_plots, false)
