...
if savedata == true
    ...
    dateiName = 'Datensatz_Reibung_Nruns_' + string(number_runs) + '.mat';   
...
% Plot 2
Quad_Subplot(samples_vec, {features_training(:, 5), Mass_Cor_training(:, 8), features_training(:, 6), Mass_Cor_training(:, 9)}, ...
