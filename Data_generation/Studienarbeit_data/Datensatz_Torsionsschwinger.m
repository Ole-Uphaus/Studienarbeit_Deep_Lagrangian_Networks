...
if savedata == true
    ...
    dateiName = 'Datensatz_Torsionsschwinger_Nruns_' + string(number_runs) + '.mat';   
...
Triple_Subplot(samples_vec, {[features_training(:, 1), features_training(:, 2)], [features_training(:, 3), features_training(:, 4)], [labels_training(:, 1), labels_training(:, 2)]}, ...
